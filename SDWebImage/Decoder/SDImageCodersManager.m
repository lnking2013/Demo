...
- (instancetype)init {
    if (self = [super init]) {
        ...
        _imageCoders = [NSMutableArray arrayWithArray:@[[SDImageIOCoder sharedCoder], [SDImageGIFCoder sharedCoder], [SDImageAPNGCoder sharedCoder],[SDImageWebPCoder sharedCoder]]];
